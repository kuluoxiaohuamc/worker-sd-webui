...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/worker-sd-webui)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/worker-sd-webui
```

A live public deployment of this template is available at [https://worker-sd-webui.templates.workers.dev](https://worker-sd-webui.templates.workers.dev)
